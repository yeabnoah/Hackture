        ...
        flex-grow lg:w-1/2 flex items-center justify-center bg-gray-50 dark:bg-black transition-colors duration-300 md:h-screen overflow-y-auto">
          <div className="w-full max-w-md space-y-6 sm:space-y-8">
            <div className='mt-5'>
              ...
              <h3 className="text-lg md:text-xl font-semibold mb-2 text-gray-700 dark:text-gray-300">Create Account</h3>
            </div>
            ...
            <OauthLogin />
            <p className="text-center text-gray-600 dark:text-gray-400 text-xs md:text-sm mt-8">
              Already have an account?{" "}
              <Link href="/login" className="text-blue-600 hover:text-blue-800 dark:text-primaryColor  font-medium">
                Login
              </Link>
            </p>
          </div>
