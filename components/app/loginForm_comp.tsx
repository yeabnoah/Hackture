    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="pl-10 py-2 bg-white dark:bg-black text-gray-900 dark:text-[#A7EE43] placeholder:text-gray-400 dark:placeholder:text-gray-500 placeholder:opacity-50"
                            required
                        />
                    </div>
                </div>
                ...
                <Button
                    type="submit"
                    className="w-full bg-[#A7EE43] text-sm hover:bg-[#A7EE43] dark:bg-[#A7EE43] dark:text-black text-black py-2 rounded-xl transition duration-300 ease-in-out"
                    disabled={isLoading}
                >
